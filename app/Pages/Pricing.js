  ...
  const plans = [
    {
      ...
      image:
        "https://i.pinimg.com/736x/e4/c9/f3/e4c9f33d855b5b6dfebd7c1c3be09167.jpg",
    },
    {
      title: "2 BHK",
      price: "10999",
    ...
    },
    {
      ...
      image:
        "https://img.staticmb.com/mbcontent/images/crop/uploads/2022/12/Most-Beautiful-House-in-the-World_0_1200.jpg",
    },
    {
      title: "Custom",
      price: "",
              ...
              <div className="p-4 w-1/2">
                ...
                {plan.title === "Custom" && (
                  <>
                    <p className="text-md mb-4 font-bold">
                      No of Units:{" "}
                      <span className="text-sky-500">{customUnits || "0"}</span>
                    </p>
                    <input
                      type="number"
                      value={customUnits}
