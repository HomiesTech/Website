...
const Home = () => {
  return (
    <section className="h-[33rem] md:h-[33rem] flex">
      <div className="w-1/2 bg-white flex items-center justify-center p-4 md:p-20">
      ...
      <div className="w-1/2 bg-purple-700 flex items-center justify-center p-4 md:p-20">
        <div
          ...
          <div className="carousel-inner relative w-full overflow-hidden">
            <div className="carousel-item active relative float-left w-full">
              <div className="img-box">
                <img src={sliderImg} alt="slider" className="block w-full" />
              </div>
            </div>
          </div>
        </div>
